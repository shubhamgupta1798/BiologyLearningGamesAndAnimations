$(document).ready(function () {
    ...
    $( "#submit" ).click(function() {
        ...
        $('.question').each(function() {
            ...
            if ((($q.attr("id") == "#2") && (($q.children().attr("id") == "a2")||($q.children().attr("id") == "a3"))) ||
             (($q.attr("id") == "#3") && (($q.children().attr("id") == "a2")||($q.children().attr("id") == "a3"))) ||
            (($q.attr("id") == "#4") && (($q.children().attr("id") == "a4")||($q.children().attr("id") == "a5"))) ||
            (($q.attr("id") == "#5") && (($q.children().attr("id") == "a4")||($q.children().attr("id") == "a5"))) ||
            (($q.attr("id") == "#1") && ($q.children().attr("id") == "a1"))
){
