...
if ((($q.attr("id") == "#1" || $q.attr("id") == "#2" || $q.attr("id") == "#3") && (($q.children().attr("id") < 4 ) ))
||
(($q.attr("id") == "#4" || $q.attr("id") == "#5" || $q.attr("id") == "#6") && (($q.children().attr("id") == 4)  ))
||
(($q.attr("id") == "#7" || $q.attr("id") == "#8" || $q.attr("id") == "#9") && (($q.children().attr("id") > 4) ))
)
