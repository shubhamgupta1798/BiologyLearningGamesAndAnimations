...
$(document).ready(function () {
    ...
    data.forEach(function (item) {
        console.log(item);
        answers.append($(`<input type="checkbox"   class="option" name="question1" id="${item["id"]}"  ><label style="font-size: 20px;">${item["value"]}</label></input><br>`))
    });
    ...
    $("#submit").click(function() {
        ...
        !document.getElementById(2).checked && !document.getElementById(4).checked)
        {
          $q = $(this);
          console.log('here');
                        numCorrect += 1;
          ...
          if(numCorrect==1)
         $('#result').text(`You Selected right option!`);
         else {
           $('#result').text(`You have not Selected right option!`);
         }
